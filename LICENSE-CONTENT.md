...
The glossary content in this repository, specifically the term entries in `js/terms.js` (the terms, the "why it misleads" text, the replacements, the guidance, and the example sentences) and the rewrite exercises, is licensed under the Creative Commons Attribution-ShareAlike 4.0 International License (CC BY-SA 4.0).

You are free to share and adapt this content, including for commercial purposes, provided you give appropriate credit and license your adaptations under the same terms.
